...
def train(load_data, model, optimizer, iters_num, batch_size=5, lr=0.01):
    ...
    for i in range(iters_num):
        ...
        if i % iter_per_epoch == 0:
            ...
            # print("test_acc: %f, max_acc: %f" %(test_acc, max_test_acc))
    ...
    IRIS_CONFIG.dump_logs(loss, IRIS_CONFIG.LOG_PATH, "loss.pkl")
    IRIS_CONFIG.dump_logs(train_acc, IRIS_CONFIG.LOG_PATH, "train_acc.pkl")
    IRIS_CONFIG.dump_logs(test_acc, IRIS_CONFIG.LOG_PATH, "test_acc.pkl")
