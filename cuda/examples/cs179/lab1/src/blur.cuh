...
// This function will conduct the convolution for a particular thread indhex
// given all the other inputs. (See how this function is called in blur.cu
// to get an understanding of what it should do.
CUDA_CALLABLE void cuda_blur_kernel_convolution(int thread_index, float *gpu_raw_data, float *gpu_blur_v,
